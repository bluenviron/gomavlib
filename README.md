...
gomavlib is a library that implements Mavlink 2.0 and 1.0 in the Go programming language. It can be used to power UGVs, UAVs, ground stations, monitoring systems or routers acting in a Mavlink network.
