...
//
// Generated from revision https://github.com/mavlink/mavlink/tree/ab5bbb78844ecfb7d66696b56ec0148f01fea7b1
//
package matrixpilot
...
type MessagePlayTuneV2 struct {
	...
	TargetComponent uint8
	// Tune format
	Format TUNE_FORMAT `mavenum:"uint8"`
	// Tune definition
	Tune string `mavlen:"252"`
}
...
type MessageSupportedTunes struct {
	...
	Format [200]TUNE_FORMAT `mavenum:"uint8"`
}
