...
//
// Generated from revision https://github.com/mavlink/mavlink/tree/af677f748aa2c3268f71db6f3a1c867530b51894
//
package matrixpilot
...
const (
	...
	FENCE_MITIGATE_NONE FENCE_MITIGATE = 0
	// Velocity limiting active to prevent breach
	FENCE_MITIGATE_VEL_LIMIT FENCE_MITIGATE = 1
)
...
//
type MAV_ODID_AUTH int

const (
	// No authentication type is specified.
	MAV_ODID_AUTH_NONE MAV_ODID_AUTH = 0
	// Manufacturer Programmed Unique ID.
	MAV_ODID_AUTH_MPUID MAV_ODID_AUTH = 1
)
...
const (
	...
	// Remote pilot ID as assigned by the Civil Aviation Authority.
	MAV_ODID_DESC_TYPE_REMOTE_PILOT_ID MAV_ODID_DESC_TYPE = 1
)
...
//
type MAV_ODID_IDTYPE int

const (
	// No type defined.
	MAV_ODID_IDTYPE_NONE MAV_ODID_IDTYPE = 0
	// Manufacturer Serial Number (ANSI/CTA-2063 format).
	MAV_ODID_IDTYPE_SERIAL_NUMBER MAV_ODID_IDTYPE = 1
	// CAA (Civil Aviation Authority) assigned ID. Format: [ICAO Country Code].[CAA Assigned ID]
	MAV_ODID_IDTYPE_CAA_ASSIGNED_ID MAV_ODID_IDTYPE = 2
	// UTM (Unmanned Traffic Management) assigned ID (UUID RFC4122).
	MAV_ODID_IDTYPE_UTM_ASSIGNED_ID MAV_ODID_IDTYPE = 3
)
...
const (
	...
	// The speed accuracy is smaller than 10 meter per second.
	MAV_ODID_SPEED_ACC_10_METER_PER_SECOND MAV_ODID_SPEED_ACC = 1
	// The speed accuracy is smaller than 3 meter per second.
	MAV_ODID_SPEED_ACC_3_METER_PER_SECOND MAV_ODID_SPEED_ACC = 2
	// The speed accuracy is smaller than 1 meter per second.
	MAV_ODID_SPEED_ACC_1_METER_PER_SECOND MAV_ODID_SPEED_ACC = 3
	// The speed accuracy is smaller than 0.3 meter per second.
	MAV_ODID_SPEED_ACC_0_3_METER_PER_SECOND MAV_ODID_SPEED_ACC = 4
)
...
//
type MAV_ODID_UATYPE int

const (
	// No UA (Unmanned Aircraft) type defined.
	MAV_ODID_UATYPE_NONE MAV_ODID_UATYPE = 0
	// Aeroplane/Airplane.
	MAV_ODID_UATYPE_AEROPLANE MAV_ODID_UATYPE = 1
	// Rotorcraft (including Multirotor).
	MAV_ODID_UATYPE_ROTORCRAFT MAV_ODID_UATYPE = 2
	// Gyroplane.
	MAV_ODID_UATYPE_GYROPLANE MAV_ODID_UATYPE = 3
	// VTOL (Vertical Take-Off and Landing). Fixed wing aircraft that can take off vertically.
	MAV_ODID_UATYPE_VTOL MAV_ODID_UATYPE = 4
	// Ornithopter.
	MAV_ODID_UATYPE_ORNITHOPTER MAV_ODID_UATYPE = 5
	// Glider.
	MAV_ODID_UATYPE_GLIDER MAV_ODID_UATYPE = 6
	// Kite.
	MAV_ODID_UATYPE_KITE MAV_ODID_UATYPE = 7
	// Free Balloon.
	MAV_ODID_UATYPE_FREE_BALLOON MAV_ODID_UATYPE = 8
	// Captive Balloon.
	MAV_ODID_UATYPE_CAPTIVE_BALLOON MAV_ODID_UATYPE = 9
	// Airship.
	MAV_ODID_UATYPE_AIRSHIP MAV_ODID_UATYPE = 10
	// Free Fall/Parachute.
	MAV_ODID_UATYPE_FREE_FALL_PARACHUTE MAV_ODID_UATYPE = 11
	// Rocket.
	MAV_ODID_UATYPE_ROCKET MAV_ODID_UATYPE = 12
	// Ground Obstacle.
	MAV_ODID_UATYPE_GROUND_OBSTACLE MAV_ODID_UATYPE = 13
	// Reserved.
	MAV_ODID_UATYPE_RESERVED MAV_ODID_UATYPE = 14
	// Other type of aircraft not listed earlier.
	MAV_ODID_UATYPE_OTHER MAV_ODID_UATYPE = 15
)
...
type MessageTunnel struct {
	...
	TargetComponent uint8
	// A code that identifies the content of the payload (0 for unknown, which is the default). If this code is less than 32768, it is a 'registered' payload type and the corresponding code should be added to the MAV_TUNNEL_PAYLOAD_TYPE enum, and the entry possibly to https://github.com/mavlink/mavlink/definition_files/tunnel_message_payload_types.xml. Software creators can register blocks of types as needed. Codes greater than 32767 are considered local experiments and should not be checked in to any widely distributed codebase.
...
type MessageOpenDroneIdBasicId struct {
	...
	IdType MAV_ODID_IDTYPE `mavenum:"uint8"`
	// Indicates the type of UA (Unmanned Aircraft).
	UaType MAV_ODID_UATYPE `mavenum:"uint8"`
	// UAS ID following the format specified by id_type. Shall be filled with nulls in the unused portion of the field.
	UasId [20]uint8
}
...
type MessageOpenDroneIdLocation struct {
	...
	// The vertical speed. Up is positive.
	SpeedVertical int16
	// Current latitude of the UA.
	Latitude int32
	// Current longitude of the UA.
	Longitude int32
	...
	// The current height of the UA above the take-off location or the ground as indicated by height_reference.
	Height float32
...
type MessageOpenDroneIdAuthentication struct {
	...
	AuthenticationType MAV_ODID_AUTH `mavenum:"uint8"`
	// Allowed range is 0 - 15.
	DataPage uint8
	// Opaque authentication data. Sixteen pages are supported for a total of 16 * 23 = 368 bytes. Shall be filled with nulls in the unused portion of the field.
...
type MessageOpenDroneIdSystem struct {
	// Specifies the location source for the remote pilot location.
	Flags MAV_ODID_LOCATION_SRC `mavenum:"uint8"`
	// Latitude of the remote pilot.
	RemotePilotLatitude int32
	// Longitude of the remote pilot.
	RemotePilotLongitude int32
	// Number of aircraft in group or formation (default 0).
	GroupCount uint16
	// Radius of cylindrical area of group or formation (default 0).
	GroupRadius uint16
	// Group Operations Ceiling relative to WGS84.
	GroupCeiling float32
	// Group Operations Floor relative to WGS84.
	GroupFloor float32
}
