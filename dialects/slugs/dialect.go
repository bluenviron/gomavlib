...
//
// Generated from revision https://github.com/mavlink/mavlink/tree/7cf9608588b59d88f7417d668fce69b312e82323
//
...
// MarshalText implements the encoding.TextMarshaler interface.
func (e CONTROL_SURFACE_FLAG) MarshalText() ([]byte, error) {
	switch e {
	case CONTROL_SURFACE_FLAG_THROTTLE:
		return []byte("CONTROL_SURFACE_FLAG_THROTTLE"), nil
	case CONTROL_SURFACE_FLAG_LEFT_AILERON:
		return []byte("CONTROL_SURFACE_FLAG_LEFT_AILERON"), nil
	case CONTROL_SURFACE_FLAG_RIGHT_AILERON:
		return []byte("CONTROL_SURFACE_FLAG_RIGHT_AILERON"), nil
	case CONTROL_SURFACE_FLAG_RUDDER:
		return []byte("CONTROL_SURFACE_FLAG_RUDDER"), nil
	case CONTROL_SURFACE_FLAG_LEFT_ELEVATOR:
		return []byte("CONTROL_SURFACE_FLAG_LEFT_ELEVATOR"), nil
	case CONTROL_SURFACE_FLAG_RIGHT_ELEVATOR:
		return []byte("CONTROL_SURFACE_FLAG_RIGHT_ELEVATOR"), nil
	case CONTROL_SURFACE_FLAG_LEFT_FLAP:
		return []byte("CONTROL_SURFACE_FLAG_LEFT_FLAP"), nil
	case CONTROL_SURFACE_FLAG_RIGHT_FLAP:
		return []byte("CONTROL_SURFACE_FLAG_RIGHT_FLAP"), nil
	}
	return nil, errors.New("invalid value")
}

// UnmarshalText implements the encoding.TextUnmarshaler interface.
func (e *CONTROL_SURFACE_FLAG) UnmarshalText(text []byte) error {
	switch string(text) {
	case "CONTROL_SURFACE_FLAG_THROTTLE":
		*e = CONTROL_SURFACE_FLAG_THROTTLE
		return nil
	case "CONTROL_SURFACE_FLAG_LEFT_AILERON":
		*e = CONTROL_SURFACE_FLAG_LEFT_AILERON
		return nil
	case "CONTROL_SURFACE_FLAG_RIGHT_AILERON":
		*e = CONTROL_SURFACE_FLAG_RIGHT_AILERON
		return nil
	case "CONTROL_SURFACE_FLAG_RUDDER":
		*e = CONTROL_SURFACE_FLAG_RUDDER
		return nil
	case "CONTROL_SURFACE_FLAG_LEFT_ELEVATOR":
		*e = CONTROL_SURFACE_FLAG_LEFT_ELEVATOR
		return nil
	case "CONTROL_SURFACE_FLAG_RIGHT_ELEVATOR":
		*e = CONTROL_SURFACE_FLAG_RIGHT_ELEVATOR
		return nil
	case "CONTROL_SURFACE_FLAG_LEFT_FLAP":
		*e = CONTROL_SURFACE_FLAG_LEFT_FLAP
		return nil
	case "CONTROL_SURFACE_FLAG_RIGHT_FLAP":
		*e = CONTROL_SURFACE_FLAG_RIGHT_FLAP
		return nil
	}
	return errors.New("invalid value")
}
...
// String implements the fmt.Stringer interface.
func (e CONTROL_SURFACE_FLAG) String() string {
	byts, err := e.MarshalText()
	if err == nil {
		return string(byts)
	}
...
type GENERATOR_STATUS_FLAG int

const (
	// Generator is off.
	GENERATOR_STATUS_FLAG_OFF GENERATOR_STATUS_FLAG = 1
	// Generator is ready to start generating power.
	GENERATOR_STATUS_FLAG_READY GENERATOR_STATUS_FLAG = 2
	// Generator is generating power.
	GENERATOR_STATUS_FLAG_GENERATING GENERATOR_STATUS_FLAG = 4
	// Generator is charging the batteries (generating enough power to charge and provide the load).
	GENERATOR_STATUS_FLAG_CHARGING GENERATOR_STATUS_FLAG = 8
	// Generator is operating at a reduced maximum power.
	GENERATOR_STATUS_FLAG_REDUCED_POWER GENERATOR_STATUS_FLAG = 16
	// Generator is providing the maximum output.
	GENERATOR_STATUS_FLAG_MAXPOWER GENERATOR_STATUS_FLAG = 32
	// Generator is near the maximum operating temperature, cooling is insufficient.
	GENERATOR_STATUS_FLAG_OVERTEMP_WARNING GENERATOR_STATUS_FLAG = 64
	// Generator hit the maximum operating temperature and shutdown.
	GENERATOR_STATUS_FLAG_OVERTEMP_FAULT GENERATOR_STATUS_FLAG = 128
	// Power electronics are near the maximum operating temperature, cooling is insufficient.
	GENERATOR_STATUS_FLAG_ELECTRONICS_OVERTEMP_WARNING GENERATOR_STATUS_FLAG = 256
	// Power electronics hit the maximum operating temperature and shutdown.
	GENERATOR_STATUS_FLAG_ELECTRONICS_OVERTEMP_FAULT GENERATOR_STATUS_FLAG = 512
	// Power electronics experienced a fault and shutdown.
	GENERATOR_STATUS_FLAG_ELECTRONICS_FAULT GENERATOR_STATUS_FLAG = 1024
	...
	GENERATOR_STATUS_FLAG_POWERSOURCE_FAULT GENERATOR_STATUS_FLAG = 2048
	// Generator controller having communication problems.
	GENERATOR_STATUS_FLAG_COMMUNICATION_WARNING GENERATOR_STATUS_FLAG = 4096
	// Power electronic or generator cooling system error.
	GENERATOR_STATUS_FLAG_COOLING_WARNING GENERATOR_STATUS_FLAG = 8192
	// Generator controller power rail experienced a fault.
	GENERATOR_STATUS_FLAG_POWER_RAIL_FAULT GENERATOR_STATUS_FLAG = 16384
	// Generator controller exceeded the overcurrent threshold and shutdown to prevent damage.
	GENERATOR_STATUS_FLAG_OVERCURRENT_FAULT GENERATOR_STATUS_FLAG = 32768
	// Generator controller detected a high current going into the batteries and shutdown to prevent battery damage.
	GENERATOR_STATUS_FLAG_BATTERY_OVERCHARGE_CURRENT_FAULT GENERATOR_STATUS_FLAG = 65536
	// Generator controller exceeded it's overvoltage threshold and shutdown to prevent it exceeding the voltage rating.
	GENERATOR_STATUS_FLAG_OVERVOLTAGE_FAULT GENERATOR_STATUS_FLAG = 131072
)

// MarshalText implements the encoding.TextMarshaler interface.
func (e GENERATOR_STATUS_FLAG) MarshalText() ([]byte, error) {
	switch e {
	case GENERATOR_STATUS_FLAG_OFF:
		return []byte("GENERATOR_STATUS_FLAG_OFF"), nil
	case GENERATOR_STATUS_FLAG_READY:
		return []byte("GENERATOR_STATUS_FLAG_READY"), nil
	case GENERATOR_STATUS_FLAG_GENERATING:
		return []byte("GENERATOR_STATUS_FLAG_GENERATING"), nil
	case GENERATOR_STATUS_FLAG_CHARGING:
		return []byte("GENERATOR_STATUS_FLAG_CHARGING"), nil
	case GENERATOR_STATUS_FLAG_REDUCED_POWER:
		return []byte("GENERATOR_STATUS_FLAG_REDUCED_POWER"), nil
	case GENERATOR_STATUS_FLAG_MAXPOWER:
		return []byte("GENERATOR_STATUS_FLAG_MAXPOWER"), nil
	case GENERATOR_STATUS_FLAG_OVERTEMP_WARNING:
		return []byte("GENERATOR_STATUS_FLAG_OVERTEMP_WARNING"), nil
	case GENERATOR_STATUS_FLAG_OVERTEMP_FAULT:
		return []byte("GENERATOR_STATUS_FLAG_OVERTEMP_FAULT"), nil
	case GENERATOR_STATUS_FLAG_ELECTRONICS_OVERTEMP_WARNING:
		return []byte("GENERATOR_STATUS_FLAG_ELECTRONICS_OVERTEMP_WARNING"), nil
	case GENERATOR_STATUS_FLAG_ELECTRONICS_OVERTEMP_FAULT:
		return []byte("GENERATOR_STATUS_FLAG_ELECTRONICS_OVERTEMP_FAULT"), nil
	case GENERATOR_STATUS_FLAG_ELECTRONICS_FAULT:
		return []byte("GENERATOR_STATUS_FLAG_ELECTRONICS_FAULT"), nil
	case GENERATOR_STATUS_FLAG_POWERSOURCE_FAULT:
		return []byte("GENERATOR_STATUS_FLAG_POWERSOURCE_FAULT"), nil
	case GENERATOR_STATUS_FLAG_COMMUNICATION_WARNING:
		return []byte("GENERATOR_STATUS_FLAG_COMMUNICATION_WARNING"), nil
	case GENERATOR_STATUS_FLAG_COOLING_WARNING:
		return []byte("GENERATOR_STATUS_FLAG_COOLING_WARNING"), nil
	case GENERATOR_STATUS_FLAG_POWER_RAIL_FAULT:
		return []byte("GENERATOR_STATUS_FLAG_POWER_RAIL_FAULT"), nil
	case GENERATOR_STATUS_FLAG_OVERCURRENT_FAULT:
		return []byte("GENERATOR_STATUS_FLAG_OVERCURRENT_FAULT"), nil
	case GENERATOR_STATUS_FLAG_BATTERY_OVERCHARGE_CURRENT_FAULT:
		return []byte("GENERATOR_STATUS_FLAG_BATTERY_OVERCHARGE_CURRENT_FAULT"), nil
	case GENERATOR_STATUS_FLAG_OVERVOLTAGE_FAULT:
		return []byte("GENERATOR_STATUS_FLAG_OVERVOLTAGE_FAULT"), nil
	}
	return nil, errors.New("invalid value")
}

// UnmarshalText implements the encoding.TextUnmarshaler interface.
func (e *GENERATOR_STATUS_FLAG) UnmarshalText(text []byte) error {
	switch string(text) {
	case "GENERATOR_STATUS_FLAG_OFF":
		*e = GENERATOR_STATUS_FLAG_OFF
		return nil
	case "GENERATOR_STATUS_FLAG_READY":
		*e = GENERATOR_STATUS_FLAG_READY
		return nil
	case "GENERATOR_STATUS_FLAG_GENERATING":
		*e = GENERATOR_STATUS_FLAG_GENERATING
		return nil
	case "GENERATOR_STATUS_FLAG_CHARGING":
		*e = GENERATOR_STATUS_FLAG_CHARGING
		return nil
	case "GENERATOR_STATUS_FLAG_REDUCED_POWER":
		*e = GENERATOR_STATUS_FLAG_REDUCED_POWER
		return nil
	case "GENERATOR_STATUS_FLAG_MAXPOWER":
		*e = GENERATOR_STATUS_FLAG_MAXPOWER
		return nil
	case "GENERATOR_STATUS_FLAG_OVERTEMP_WARNING":
		*e = GENERATOR_STATUS_FLAG_OVERTEMP_WARNING
		return nil
	case "GENERATOR_STATUS_FLAG_OVERTEMP_FAULT":
		*e = GENERATOR_STATUS_FLAG_OVERTEMP_FAULT
		return nil
	case "GENERATOR_STATUS_FLAG_ELECTRONICS_OVERTEMP_WARNING":
		*e = GENERATOR_STATUS_FLAG_ELECTRONICS_OVERTEMP_WARNING
		return nil
	case "GENERATOR_STATUS_FLAG_ELECTRONICS_OVERTEMP_FAULT":
		*e = GENERATOR_STATUS_FLAG_ELECTRONICS_OVERTEMP_FAULT
		return nil
	case "GENERATOR_STATUS_FLAG_ELECTRONICS_FAULT":
		*e = GENERATOR_STATUS_FLAG_ELECTRONICS_FAULT
		return nil
	case "GENERATOR_STATUS_FLAG_POWERSOURCE_FAULT":
		*e = GENERATOR_STATUS_FLAG_POWERSOURCE_FAULT
		return nil
	case "GENERATOR_STATUS_FLAG_COMMUNICATION_WARNING":
		*e = GENERATOR_STATUS_FLAG_COMMUNICATION_WARNING
		return nil
	case "GENERATOR_STATUS_FLAG_COOLING_WARNING":
		*e = GENERATOR_STATUS_FLAG_COOLING_WARNING
		return nil
	case "GENERATOR_STATUS_FLAG_POWER_RAIL_FAULT":
		*e = GENERATOR_STATUS_FLAG_POWER_RAIL_FAULT
		return nil
	case "GENERATOR_STATUS_FLAG_OVERCURRENT_FAULT":
		*e = GENERATOR_STATUS_FLAG_OVERCURRENT_FAULT
		return nil
	case "GENERATOR_STATUS_FLAG_BATTERY_OVERCHARGE_CURRENT_FAULT":
		*e = GENERATOR_STATUS_FLAG_BATTERY_OVERCHARGE_CURRENT_FAULT
		return nil
	case "GENERATOR_STATUS_FLAG_OVERVOLTAGE_FAULT":
		*e = GENERATOR_STATUS_FLAG_OVERVOLTAGE_FAULT
		return nil
	}
	return errors.New("invalid value")
}
...
// String implements the fmt.Stringer interface.
func (e GENERATOR_STATUS_FLAG) String() string {
	byts, err := e.MarshalText()
	if err == nil {
		return string(byts)
	}
...
func (e MAV_CMD) MarshalText() ([]byte, error) {
	...
	case MAV_CMD_DO_NOTHING:
		return []byte("MAV_CMD_DO_NOTHING"), nil
	case MAV_CMD_RETURN_TO_BASE:
		return []byte("MAV_CMD_RETURN_TO_BASE"), nil
	case MAV_CMD_STOP_RETURN_TO_BASE:
		return []byte("MAV_CMD_STOP_RETURN_TO_BASE"), nil
	case MAV_CMD_TURN_LIGHT:
		return []byte("MAV_CMD_TURN_LIGHT"), nil
	case MAV_CMD_GET_MID_LEVEL_COMMANDS:
		return []byte("MAV_CMD_GET_MID_LEVEL_COMMANDS"), nil
	case MAV_CMD_MIDLEVEL_STORAGE:
		return []byte("MAV_CMD_MIDLEVEL_STORAGE"), nil
	}
	return nil, errors.New("invalid value")
}
...
func (e *MAV_CMD) UnmarshalText(text []byte) error {
	...
	case "MAV_CMD_USER_5":
		*e = MAV_CMD_USER_5
		return nil
	case "MAV_CMD_DO_NOTHING":
		*e = MAV_CMD_DO_NOTHING
		return nil
	case "MAV_CMD_RETURN_TO_BASE":
		*e = MAV_CMD_RETURN_TO_BASE
		return nil
	case "MAV_CMD_STOP_RETURN_TO_BASE":
		*e = MAV_CMD_STOP_RETURN_TO_BASE
		return nil
	case "MAV_CMD_TURN_LIGHT":
		*e = MAV_CMD_TURN_LIGHT
		return nil
	case "MAV_CMD_GET_MID_LEVEL_COMMANDS":
		*e = MAV_CMD_GET_MID_LEVEL_COMMANDS
		return nil
	case "MAV_CMD_MIDLEVEL_STORAGE":
		*e = MAV_CMD_MIDLEVEL_STORAGE
		return nil
	}
	return errors.New("invalid value")
}
...
// MarshalText implements the encoding.TextMarshaler interface.
func (e SLUGS_MODE) MarshalText() ([]byte, error) {
	switch e {
	case SLUGS_MODE_NONE:
		return []byte("SLUGS_MODE_NONE"), nil
	case SLUGS_MODE_LIFTOFF:
		return []byte("SLUGS_MODE_LIFTOFF"), nil
	case SLUGS_MODE_PASSTHROUGH:
		return []byte("SLUGS_MODE_PASSTHROUGH"), nil
	case SLUGS_MODE_WAYPOINT:
		return []byte("SLUGS_MODE_WAYPOINT"), nil
	case SLUGS_MODE_MID_LEVEL:
		return []byte("SLUGS_MODE_MID_LEVEL"), nil
	case SLUGS_MODE_RETURNING:
		return []byte("SLUGS_MODE_RETURNING"), nil
	case SLUGS_MODE_LANDING:
		return []byte("SLUGS_MODE_LANDING"), nil
	case SLUGS_MODE_LOST:
		return []byte("SLUGS_MODE_LOST"), nil
	case SLUGS_MODE_SELECTIVE_PASSTHROUGH:
		return []byte("SLUGS_MODE_SELECTIVE_PASSTHROUGH"), nil
	case SLUGS_MODE_ISR:
		return []byte("SLUGS_MODE_ISR"), nil
	case SLUGS_MODE_LINE_PATROL:
		return []byte("SLUGS_MODE_LINE_PATROL"), nil
	case SLUGS_MODE_GROUNDED:
		return []byte("SLUGS_MODE_GROUNDED"), nil
	}
	return nil, errors.New("invalid value")
}

// UnmarshalText implements the encoding.TextUnmarshaler interface.
func (e *SLUGS_MODE) UnmarshalText(text []byte) error {
	switch string(text) {
	case "SLUGS_MODE_NONE":
		*e = SLUGS_MODE_NONE
		return nil
	case "SLUGS_MODE_LIFTOFF":
		*e = SLUGS_MODE_LIFTOFF
		return nil
	case "SLUGS_MODE_PASSTHROUGH":
		*e = SLUGS_MODE_PASSTHROUGH
		return nil
	case "SLUGS_MODE_WAYPOINT":
		*e = SLUGS_MODE_WAYPOINT
		return nil
	case "SLUGS_MODE_MID_LEVEL":
		*e = SLUGS_MODE_MID_LEVEL
		return nil
	case "SLUGS_MODE_RETURNING":
		*e = SLUGS_MODE_RETURNING
		return nil
	case "SLUGS_MODE_LANDING":
		*e = SLUGS_MODE_LANDING
		return nil
	case "SLUGS_MODE_LOST":
		*e = SLUGS_MODE_LOST
		return nil
	case "SLUGS_MODE_SELECTIVE_PASSTHROUGH":
		*e = SLUGS_MODE_SELECTIVE_PASSTHROUGH
		return nil
	case "SLUGS_MODE_ISR":
		*e = SLUGS_MODE_ISR
		return nil
	case "SLUGS_MODE_LINE_PATROL":
		*e = SLUGS_MODE_LINE_PATROL
		return nil
	case "SLUGS_MODE_GROUNDED":
		*e = SLUGS_MODE_GROUNDED
		return nil
	}
	return errors.New("invalid value")
}
...
// String implements the fmt.Stringer interface.
func (e SLUGS_MODE) String() string {
	byts, err := e.MarshalText()
	if err == nil {
		return string(byts)
	}
...
type MessageGeneratorStatus struct {
	// Status flags.
	Status GENERATOR_STATUS_FLAG `mavenum:"uint64"`
