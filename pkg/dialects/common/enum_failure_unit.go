...
const (
	...
	FAILURE_UNIT_SYSTEM_ESC FAILURE_UNIT = 106
	// Traffic avoidance system like ADS-B or FLARM.
	FAILURE_UNIT_SYSTEM_TRAFFIC_AVOIDANCE FAILURE_UNIT = 107
	// Data link over a cellular (LTE) connection.
	FAILURE_UNIT_DATALINK_LTE FAILURE_UNIT = 150
	// Data link over a Wi-Fi connection.
	FAILURE_UNIT_DATALINK_WIFI FAILURE_UNIT = 151
	// Data link over a telemetry radio, e.g. a SiK radio.
	FAILURE_UNIT_DATALINK_TELEM_RADIO FAILURE_UNIT = 152
	// CAN bus. Instance is the bus number, e.g. 1 for CAN1.
	FAILURE_UNIT_BUS_CAN FAILURE_UNIT = 200
	// I2C bus. Instance is the bus number, e.g. 1 for I2C1.
	FAILURE_UNIT_BUS_I2C FAILURE_UNIT = 201
)
...
var value_to_label_FAILURE_UNIT = map[FAILURE_UNIT]string{
	...
	FAILURE_UNIT_SYSTEM_ESC:               "FAILURE_UNIT_SYSTEM_ESC",
	FAILURE_UNIT_SYSTEM_TRAFFIC_AVOIDANCE: "FAILURE_UNIT_SYSTEM_TRAFFIC_AVOIDANCE",
	FAILURE_UNIT_DATALINK_LTE:             "FAILURE_UNIT_DATALINK_LTE",
	FAILURE_UNIT_DATALINK_WIFI:            "FAILURE_UNIT_DATALINK_WIFI",
	FAILURE_UNIT_DATALINK_TELEM_RADIO:     "FAILURE_UNIT_DATALINK_TELEM_RADIO",
	FAILURE_UNIT_BUS_CAN:                  "FAILURE_UNIT_BUS_CAN",
	FAILURE_UNIT_BUS_I2C:                  "FAILURE_UNIT_BUS_I2C",
}
