...
const (
	...
	GIMBAL_DEVICE_CAP_FLAGS_CAN_POINT_LOCATION_LOCAL GIMBAL_DEVICE_CAP_FLAGS = 65536
	// Gimbal device supports to point to a global latitude, longitude, altitude position.
	GIMBAL_DEVICE_CAP_FLAGS_CAN_POINT_LOCATION_GLOBAL GIMBAL_DEVICE_CAP_FLAGS = 131072
)
...
var values_GIMBAL_DEVICE_CAP_FLAGS = []GIMBAL_DEVICE_CAP_FLAGS{
	...
	GIMBAL_DEVICE_CAP_FLAGS_CAN_POINT_LOCATION_LOCAL,
...
var value_to_label_GIMBAL_DEVICE_CAP_FLAGS = map[GIMBAL_DEVICE_CAP_FLAGS]string{
	...
	GIMBAL_DEVICE_CAP_FLAGS_CAN_POINT_LOCATION_LOCAL:    "GIMBAL_DEVICE_CAP_FLAGS_CAN_POINT_LOCATION_LOCAL",
