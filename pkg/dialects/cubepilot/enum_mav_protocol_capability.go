...
const (
	...
	MAV_PROTOCOL_CAPABILITY_RESERVED3 MAV_PROTOCOL_CAPABILITY = common.MAV_PROTOCOL_CAPABILITY_RESERVED3
	...
	MAV_PROTOCOL_CAPABILITY_GRIPPER MAV_PROTOCOL_CAPABILITY = common.MAV_PROTOCOL_CAPABILITY_GRIPPER
)
