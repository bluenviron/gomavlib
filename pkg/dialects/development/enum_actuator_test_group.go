...
const (
	...
	ACTUATOR_TEST_GROUP_X_THRUST ACTUATOR_TEST_GROUP = 4
	// Actuators that contribute to y (lateral, positive = right) thrust.
	ACTUATOR_TEST_GROUP_Y_THRUST ACTUATOR_TEST_GROUP = 5
	// Actuators that contribute to z (vertical, positive = down) thrust.
	ACTUATOR_TEST_GROUP_Z_THRUST ACTUATOR_TEST_GROUP = 6
)
...
var value_to_label_ACTUATOR_TEST_GROUP = map[ACTUATOR_TEST_GROUP]string{
	...
	ACTUATOR_TEST_GROUP_X_THRUST:        "ACTUATOR_TEST_GROUP_X_THRUST",
	ACTUATOR_TEST_GROUP_Y_THRUST:        "ACTUATOR_TEST_GROUP_Y_THRUST",
	ACTUATOR_TEST_GROUP_Z_THRUST:        "ACTUATOR_TEST_GROUP_Z_THRUST",
}
