...
const (
	...
	MAV_CMD_NAV_FENCE_HOME_CIRCLE_INCLUSION MAV_BATTERY_STATUS_FLAGS = 5005
	// Over-current fault.
...
var values_MAV_BATTERY_STATUS_FLAGS = []MAV_BATTERY_STATUS_FLAGS{
...
var value_to_label_MAV_BATTERY_STATUS_FLAGS = map[MAV_BATTERY_STATUS_FLAGS]string{
...
var label_to_value_MAV_BATTERY_STATUS_FLAGS = map[string]MAV_BATTERY_STATUS_FLAGS{
	"MAV_BATTERY_STATUS_FLAGS_NOT_READY_TO_USE":                       MAV_BATTERY_STATUS_FLAGS_NOT_READY_TO_USE,
	"MAV_BATTERY_STATUS_FLAGS_CHARGING":                               MAV_BATTERY_STATUS_FLAGS_CHARGING,
	"MAV_BATTERY_STATUS_FLAGS_CELL_BALANCING":                         MAV_BATTERY_STATUS_FLAGS_CELL_BALANCING,
	"MAV_BATTERY_STATUS_FLAGS_FAULT_CELL_IMBALANCE":                   MAV_BATTERY_STATUS_FLAGS_FAULT_CELL_IMBALANCE,
...
func (e MAV_BATTERY_STATUS_FLAGS) MarshalText() ([]byte, error) {
	...
	var names []string
	for _, val := range values_MAV_BATTERY_STATUS_FLAGS {
		if e&val == val {
			names = append(names, value_to_label_MAV_BATTERY_STATUS_FLAGS[val])
		}
	}
...
func (e *MAV_BATTERY_STATUS_FLAGS) UnmarshalText(text []byte) error {
	...
	for _, label := range labels {
		if value, ok := label_to_value_MAV_BATTERY_STATUS_FLAGS[label]; ok {
			mask |= value
